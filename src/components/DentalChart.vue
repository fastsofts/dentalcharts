...
<script>
 export default {
    ...
    data() { return {
         ...
         colors:[{color:'',gradient:'<linearGradient id="ceramic"><stop offset="95%" stop-color="rgba(255, 215, 0,.2)" /><stop offset="5%" stop-color="rgba(0,0,0,.5)" /></linearGradient>'},{color:'',gradient:'<linearGradient id="ceramic"><stop offset="95%" stop-color="(192, 192, 192)" /><stop offset="5%" stop-color="rgba(0,0,0,.2)" /></linearGradient>'},{color:'#fbeed5',gradient:''}],
         categories:[],
         surfaces:[],
         materials:[],
         subtypes:[],
...
//       },
       addItem(){
          if (this.selectedTeeth && this.selectedCategory){
              DrawingBoard.drawapply(this.selectedCategory.split(" ").join("").toUpperCase(),this.selectedTeeth.split("T").join(""),this.selectedCategory.split(" ").join("").toUpperCase(),this.selectedSurface,this.selectedMaterial,this.selectedType,this.selectedTypeList,this.selectedStatus,toRaw(this.masterstatus));
          }    
       },
       changeCategory(scat){    
